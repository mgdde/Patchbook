        ...
        for module in sorted(self.modules):
            ...
            for out in sorted(outputs):
                ...
                for c in connections:
                    ...
                    connection_line: str = f"{re.sub(graphVizRemoveChars, '', module)}:{out_formatted}{from_token}{re.sub(graphVizRemoveChars, '', c['input_module'])}:{in_formatted}{to_token}{line_style}"
            ...
            final_box = re.sub(graphVizRemoveChars, "", module) + "[label=\"{ {" + module_inputs + "}|" + middle + "| {" + module_outputs + "}}\"  shape=Mrecord]"
            print(final_box)
